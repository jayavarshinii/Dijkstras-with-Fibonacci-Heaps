...
public class Dijkstra {
    ...
    private static final int MAX = 5200;
    ...
    public static class Edge {
        ...
        public void setEndPoint(int e) { // set the end point
            endPoint = e;
        }
...
final static ArrayList<ArrayList<Edge>> graph = new ArrayList<ArrayList<Edge>>();
        ...
        public static int ClosestUnvisited() {
            ...
            int y = arrayofnode.positionOf(x);
            return y;
        }
    ...
    public static int readfile(String file) throws IOException {
       ...
       //Check cases
        if(s.edges>check)
        {
            System.out.println(" LARGE NUMBER OF EDGES. EDIT INPUT FILE");
            System.exit(0);
            
        }
       if(s.edges!=k/3)
        {
            System.out.println("NO OF EDGES IS NOT EQUAL TO EDGES SPECFIED");
            System.exit(0);
        }
